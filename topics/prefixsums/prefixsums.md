...
запроса $$\mathit{pref}(r)$$ и $$\mathit{pref}(l - 1)$$, где
$$\mathit{pref}(x)$$ - сумма чисел от $$a[0]$$ до $$a[x]$$,
или **сумма на префиксе $$x$$**. Но ведь мы можем просто предпросчитать
$$\mathit{pref}$$ для всех $$x$$ за $$O(N)$$ элементарным ДП:
