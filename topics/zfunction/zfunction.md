...
длина $$j$$, такая что $$s[0..j - 1] = s[i..i + j - 1]$$. Другими словами,
$$z[i]$$ - длина максимального префикса строки $$s$$, совпадающего с префиксом её
$$i$$-го суффикса.

![Z-функция строки "abacaba"](z.png)
...
![Z-функция строки "ababacababa"](z2.png)
